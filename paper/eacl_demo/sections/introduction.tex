...
Scientific-document QA benchmarks such as QASPER, SciFact, and M3SciQA show the need to reason over scholarly evidence~\citep{dasigi2021qasper,wadden2020scifact,li2024m3sciqa}; citation-grounded generation studies evaluate whether retrieved context is used~\citep{gao2023alce,asai2024selfrag}; and multimodal document systems show why page layout and visual evidence matter~\citep{banerjee2024spiqa,faysse2025colpali}. ScholAR's demo contribution is to integrate these concerns into a local interactive workflow in which citations retain spatial identity and can be inspected in the source document.
