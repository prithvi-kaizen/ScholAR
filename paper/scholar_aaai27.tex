...
\author{
  ...
  $^1$Department of Computer Science, Anonymous Institution \\
  $^2$Department of Computer Science, Anonymous Institution \\
  \texttt{\{prithviraj, nidhi\}@example.edu}
}
...
Our BM25-primary retrieval system achieves Recall@5 of 1.00 and MRR of 0.812,
outperforming keyword-overlap baselines by 12.5 percentage points in MRR.
\end{abstract}
...
(\texttt{qwen3.5:9b}) for local inference.
